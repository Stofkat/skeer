  ...
  return (
    <div className="page-privacy">
      <div className="content">
        ...
        Alle gegevens die je invoert op Skeer staan alleen lokaal opgeslagen binnen je brower (of app).
        Door simpelweg je browser geschiedenis te verwijderen of de app te deinstalleren zijn al deze gegevens weg.
        <br /><br />
        ...
        All data you enter on Skeer is only stored locally within your browser (or app).
        Simply by deleting your browser history or uninstalling the app, all this data is gone.
        <br /><br />
